...
Public Class FrmLookupCust

    Public IDCust As String = ""
    ...
    Private Sub ShowData(Optional ByVal Key As String = "")
        Dim Sql As String
        Sql = "Select KodeCustomer,NamaCustomer,Alamat01 from tcustomer where NamaCustomer like '%" & Key & "%'"
    ...
    Private Sub View_CellContentDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles View.CellContentDoubleClick
        IDCust = View(0, View.CurrentCell.RowIndex).Value
        NamaCust = View(1, View.CurrentCell.RowIndex).Value
