...
Public Class FrmLookupSale
    Public IDSales As String = ""
    ...
    Private Sub ShowData(Optional ByVal Key As String = "")
        Dim Sql As String
        Sql = "Select KodeSales,NamaSales from tsales where NamaSales like '%" & Key & "%'"
    ...
    Private Sub View_CellContentDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles View.CellContentDoubleClick
        IDSales = View(0, View.CurrentCell.RowIndex).Value
        NamaSales = View(1, View.CurrentCell.RowIndex).Value
